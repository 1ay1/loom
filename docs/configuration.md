...
| Theme | Description |
|---|---|
| `default` | Clean neutral grays, blue accent, system font |
| `serif` | Georgia/Garamond, warm tones, literary feel |
| `mono` | Monospace font, terminal/hacker aesthetic, green accent |
| `nord` | Arctic color palette (Nord), Inter font |
| `rose` | Soft pinks, elegant, magenta accent |
| `cobalt` | Deep blue developer theme |
| `earth` | Warm organic tones, Charter/Georgia serif |

Each theme sets colors, fonts, and sizing for both light and dark modes.
